...
• Jika ada bug/eror di fitur kami saya mohon untuk Report nya, tanpa biaya dan aman
_Cara penggunaan XYRA BOT Agar terhindar dari Suspand_
...
4. WhatsApp Bot akan memberlakukan hukuman: block atau ban terhadap users yang melanggar peraturan.`.trim()) // Tambah sendiri kalo mau
handler.help = ['rules']
handler.tags = ['info']
