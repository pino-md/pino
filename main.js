...
//global.db = new Low(new mongoDB('masukin sini mongodb nya'))
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6285706174510@s.whatsapp.net`, {text: 'Successfully connected by Octave' }) //made by Muhammad Ridwan Reynaldy 
}
